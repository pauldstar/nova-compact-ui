...
{
    use ReactiveField { ReactiveField::jsonSerialize as reactiveFieldJsonSerialize; }
     ...
     * @return ReactiveHasMany
     */
    public function notable(bool $notable = true): self
    {
        return $this->withMeta(['notable' => $notable]);
    }
    ...
    /**
     * Resources can be imported/copied from other resources
     *
     * @param bool $importable
     * @return ReactiveHasMany
     */
    public function importable(bool $importable = true): self
    {
        return $this->withMeta(['importable' => $importable]);
    }
